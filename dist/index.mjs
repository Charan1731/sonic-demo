    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: cards.map((card) => /* @__PURE__ */ jsxs(
            "div",
            {
              style: {
              ...
              children: [
                /* @__PURE__ */ jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsx("span", { style: { fontSize: "1.6rem" }, children: card.icon })
                  }
                ),
                /* @__PURE__ */ jsx(
                  "div",
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        filteredCustomers.length === 0 ? /* @__PURE__ */ jsx(
          "div",
          {
            style: {
              padding: "2.5rem",
          ...
          "div",
          {
            ...
            children: filteredCustomers.map((customer) => /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      customer.email && /* @__PURE__ */ jsxs("span", { children: [
                        "\u{1F4E7} ",
                        /* @__PURE__ */ jsx("span", { children: customer.email })
                      ] }),
                      customer.phone && /* @__PURE__ */ jsxs("span", { children: [
                        "\u{1F4DE} ",
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              loading ? /* @__PURE__ */ jsx(
              ...
              ) : schedules.length === 0 ? /* @__PURE__ */ jsx(
                "div",
                {
                  style: {
                    padding: "2rem",
                ...
                "div",
                {
                  ...
                  children: schedules.map((schedule) => /* @__PURE__ */ jsxs(
                    "div",
                    {
                      style: {
                        padding: "1rem",
...
function SonicWidget(props) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    open && /* @__PURE__ */ jsx(SonicModal, { onClose: handleClose, theme: resolvedTheme, children: /* @__PURE__ */ jsx(
  ...
  if (loading && !connection) {
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { children: "Loading Sonic workspace\u2026" })
      }
    );
  }
  if (!connection) {
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { children: error || "Unable to load Sonic workspace. Please check your API key and try again." })
      }
    );
  }
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        activeView === "dashboard" && /* @__PURE__ */ jsx(DashboardPane, { stats, connection }),
        activeView === "customers" && /* @__PURE__ */ jsx(
          CustomersPane,
          {
            connection,
            theme,
        ...
        activeView === "customer-detail" && selectedCustomer && /* @__PURE__ */ jsx(
          CustomerDetailPane,
          {
        ...
        activeView === "seat-events" && /* @__PURE__ */ jsx(
          SeatEventsWidget,
          {
            connection,
            clientConfig,
...
function SeatEventsWidget({
  ...
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState(null);
  const [seatMeters, setSeatMeters] = useState([]);
  const [seatMetersError, setSeatMetersError] = useState(null);
  ...
  const [seatChangeType, setSeatChangeType] = useState("add");
  const [seatEventTimestamp, setSeatEventTimestamp] = useState("");
  const [seatEventDisplay, setSeatEventDisplay] = useState("");
  const [eventPickerOpen, setEventPickerOpen] = useState(false);
  const [eventDate, setEventDate] = useState(null);
  const [seatEventLoading, setSeatEventLoading] = useState(false);
  const [seatEventSuccess, setSeatEventSuccess] = useState(null);
  const [seatEventError, setSeatEventError] = useState(null);
  ...
  if (loading) {
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { children: "Loading Sonic seat events\u2026" })
      }
    );
  }
  return /* @__PURE__ */ jsx(
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsx("p", { style: { fontSize: "0.9rem", opacity: 0.8 }, children: "Quickly adjust seats for a customer and review recent changes." })
                  ] }),
                  connection && /* @__PURE__ */ jsxs(
                    "div",
                    {
                      style: {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx("span", { style: { fontWeight: 600 }, children: "Connected" }),
                        /* @__PURE__ */ jsxs("span", { style: { opacity: 0.6 }, children: [
                          "to ",
            ...
            /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                          ...
                          /* @__PURE__ */ jsxs(
                            "select",
                            {
                              ...
                              children: [
                                ...
                                connection == null ? void 0 : connection.customers.map((c) => /* @__PURE__ */ jsxs("option", { value: c.id, children: [
                                  c.name,
                                  " ",
                                  c.email ? `(${c.email})` : ""
                                ] }, c.id))
                        ...
                        /* @__PURE__ */ jsxs("div", { children: [
                          ...
                          /* @__PURE__ */ jsxs(
                            "select",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsx("option", { value: "", children: seatMetersLoading ? "Loading seat meters..." : "Select seat meter" }),
                                seatMeters.map((m) => /* @__PURE__ */ jsx("option", { value: m.id, children: m.name }, m.id))
                              ]
                            }
                          ),
                          seatMetersError && /* @__PURE__ */ jsx(
                            "div",
                            {
                              style: {
                                marginTop: "0.25rem",
                              ...
                              children: [
                                /* @__PURE__ */ jsxs(
                                  "select",
                                  {
                                    ...
                                    children: [
                                      /* @__PURE__ */ jsx("option", { value: "add", children: "Add" }),
                                      /* @__PURE__ */ jsx("option", { value: "remove", children: "Remove" })
                                    ]
                                  }
                                ),
                                /* @__PURE__ */ jsx(
                  ...
                  seatCustomerId && seatMeterId && seatEventTimestamp && (invoiceLoading || invoiceInfo || invoiceError) && /* @__PURE__ */ jsx(
                    "div",
                    {
                      style: {
                        marginTop: "1rem",
                      ...
                      children: invoiceLoading ? /* @__PURE__ */ jsx(
                        "div",
                        {
                          style: {
                            fontSize: "0.9rem"
                        ...
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxs("div", { children: [
                              /* @__PURE__ */ jsx("span", { style: { fontWeight: 600 }, children: "Invoice:" }),
                              " ",
                              invoiceInfo.invoice_number || invoiceInfo.invoice_id
                            ] }),
                            /* @__PURE__ */ jsxs("div", { children: [
                              /* @__PURE__ */ jsx("span", { style: { fontWeight: 600 }, children: "Current seats_balance:" }),
                              " ",
                              (_l = invoiceInfo.seats_balance) != null ? _l : "N/A"
                            ] }),
                            invoiceInfo.minimum_seats != null && /* @__PURE__ */ jsxs("div", { children: [
                              /* @__PURE__ */ jsx("span", { style: { fontWeight: 600 }, children: "Minimum seats:" }),
                              " ",
                      ...
                      children: /* @__PURE__ */ jsxs(
                        "table",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx("tbody", { children: events.map((ev) => {
                              var _a2, _b2, _c2;
...
function initSonicWidget(config) {
  ...
  root.render(/* @__PURE__ */ jsx2(SonicWidget, __spreadValues({}, widgetConfig)));
  return {
    destroy: () => {
      root.unmount();
      if (element._sonicWidgetRoot) {
